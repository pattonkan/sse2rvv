# Contributing to SSE2RVV

:+1::tada: First off, thanks for taking the time to contribute! :tada::+1:

The following is a set of guidelines for contributing to [SSE2RVV](https://github.com/DLTcollab/sse2rvv),
...
Visit our [Issues page on GitHub](https://github.com/DLTcollab/sse2rvv/issues) to search and submit.

## Add New Intrinsic

The new intrinsic conversion should be added in the `sse2rvv.h` file,
...
In general, global names (including enums) should have a common prefix (`SSE2RVV_` for macros and enum constants; `_sse2rvv_` for functions) identifying the module that they belong with. Globals may alternatively be grouped in a global structure. Typedeffed names often have `_t` appended to their name.
