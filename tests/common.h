...
result_t validate_uint16(__m128i a,
                         ...
                         uint16_t u6,
                         uint16_t u7);
result_t validate_int16(__m64 a,
                        int16_t i0,
                        int16_t i1,
                        int16_t i2,
                        int16_t i3);
...
result_t validate_float_error(__m128 a,
                              ...
                              float f3,
                              float err);
result_t validate_double(__m128 a, double d0, double d1);
result_t validate_float_error(__m128 a, double d0, double d1, double err);
}  // namespace SSE2RVV
