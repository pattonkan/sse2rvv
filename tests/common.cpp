...
result_t validate_int32(__m128i a,
                        int32_t i0,
                        int32_t i1,
                        int32_t i2,
                        int32_t i3)
...
result_t validate_uint32(__m128i a,
                         uint32_t u0,
                         uint32_t u1,
                         uint32_t u2,
                         uint32_t u3)
...
result_t validate_int16(__m128i a,
                        int16_t i0,
                        int16_t i1,
                        int16_t i2,
                        int16_t i3,
...
result_t validate_uint16(__m128i a,
                         uint16_t u0,
                         uint16_t u1,
                         uint16_t u2,
                         uint16_t u3,
...
result_t validate_int16(__m64 a, int16_t i0, int16_t i1, int16_t i2, int16_t i3)
{
    const int16_t *t = (const int16_t *) &a;
    ASSERT_RETURN(t[0] == i0);
    ASSERT_RETURN(t[1] == i1);
...
result_t validate_uint16(__m64 a,
                         uint16_t u0,
                         uint16_t u1,
                         uint16_t u2,
                         uint16_t u3)
...
result_t validate_int8(__m128i a,
                       int8_t i0,
                       int8_t i1,
                       int8_t i2,
                       int8_t i3,
...
result_t validate_uint8(__m128i a,
                        uint8_t u0,
                        uint8_t u1,
                        uint8_t u2,
                        uint8_t u3,
...
result_t validate_int8(__m64 a,
                       int8_t i0,
                       int8_t i1,
                       int8_t i2,
                       int8_t i3,
...
result_t validate_uint8(__m64 a,
                        uint8_t u0,
                        uint8_t u1,
                        uint8_t u2,
                        uint8_t u3,
...
result_t validate_float_epsilon(__m128 a,
                                float f0,
                                float f1,
                                float f2,
                                float f3,
...
result_t validate_float_error(__m128 a,
                              float f0,
                              float f1,
                              float f2,
                              float f3,
...
result_t validate_double(__m64 a, double d0, double d1)
{
...
result_t validate_float_error(__m64 a, double d0, double d1, double err)
{
    const double *t = (const double *) &a;
